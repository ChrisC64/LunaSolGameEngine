...
export namespace LS
{
    ...
    */
    [[nodiscard]]
    inline D3D11_USAGE FindUsageD3D11(LS::BUFFER_USAGE bufferUsage)
    {
    ...
    */
    [[nodiscard]]
    inline D3D11_BIND_FLAG FindBufferBindTypeD3D11(LS::BUFFER_BIND_TYPE bindType)
    {
    ...
    */
    template<class TObject>
    inline D3D11_BUFFER_DESC CreateBufferDescD3D11(const LS::LSBuffer<TObject>& buffer)
    {
