//TODO: Module units like this, with template declarations, seem to break intellisense for msvc
// because that's not good, we hav emoved this to LSTimer.h instead. This probably has to be 
// due to the fact that templates aren't instantiated until declaration, and headers aren't compiled
// until compile time. Perhaps a bug in Intellisense or perhaps correct behavior? The program
// still compiles with the use of a module but I don't want to deal with broken intellisense
