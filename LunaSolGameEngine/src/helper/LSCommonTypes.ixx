...
export namespace LS
{
    ...
    */
    ...
    DepthStencil DepthNone
    {
        ...
        .DepthComparison = LS::EVAL_COMPARE::LESS_EQUAL_PASS,
    ...
    DepthStencil DepthStencilDefault
    {
        ...
        .FrontFace = {
            ...
            .StencilPassDepthFailOp = DEPTH_STENCIL_OPS::INCR_THEN_CLAMP, 
            .BothPassOp = DEPTH_STENCIL_OPS::KEEP, 
            .StencilTestFunc = EVAL_COMPARE::ALWAYS_PASS 
        },
        .BackFace = {
            .StencilFailOp = DEPTH_STENCIL_OPS::KEEP, 
            .StencilPassDepthFailOp = DEPTH_STENCIL_OPS::DECR_THEN_CLAMP, 
            .BothPassOp = DEPTH_STENCIL_OPS::KEEP, 
            .StencilTestFunc = EVAL_COMPARE::ALWAYS_PASS 
        },
    };
