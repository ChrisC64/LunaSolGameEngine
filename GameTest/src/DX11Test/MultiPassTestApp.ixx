//TODO: THIS Could be erased or the conversion changes of LS::LSApp need to be implemented (we need to
// now create and derive from LS::LSApp to implement the functions that need to be overriden as 
// LS::CreateAppRef() is no longer being used.)
//module;
//#include <array>
//#include <cstdint>
//#include <filesystem>
